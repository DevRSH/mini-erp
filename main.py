...
from services.logic import (
    _margen, _producto_full, _to_iso_dt,
    _aplicar_delta_stock, _validar_consistencia_stock_producto,
    _validar_operable_para_cancelacion, _validar_operable_para_correccion,
    _crear_venta_en_transaccion, _crear_compra_en_transaccion
)
